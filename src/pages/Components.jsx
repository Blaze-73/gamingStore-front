...
const types = ['Tous', 'Processeur', 'Carte Graphique', 'RAM', 'Stockage', 'Boitier', 'Watercooler']
...
export default function Components() {
  ...
  useEffect(() => {
    api.products.list({ category: 'components' })
    ...
    <div>
      <section className="border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 md:py-14">
          <span className="tag-accent">Composants</span>
          <h1 className="heading text-4xl md:text-5xl font-black text-text mt-3 max-w-2xl">
            Montez ou améliorez votre PC
          </h1>
          <p className="text-text-muted mt-3 max-w-xl text-sm leading-relaxed">
            CPUs, GPUs, RAM, SSD, boitiers, watercooling&hellip; On a tout ce qu&rsquo;il faut.
          </p>
        </div>
      </section>
